...
export default function ApiKeyForm() {
  ...
  const handleSaveApiKeyFromDialog = (newApiKey: string) => {
    setApiKey(newApiKey)
    setIsSaved(true)
  }
  ...
  return (
    <div>
      ...
      <AuthDialog
        ...
        onSaveApiKey={handleSaveApiKeyFromDialog}
        hasServerApiKey={envStatus?.hasApiKey || false}
      />
    </div>
  )
}
